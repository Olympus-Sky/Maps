...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private GeoDataClient geoDataClient; //Lugares proximos as coordenadas
    ...
    //@SuppressWarnings("MissingPermission") //Nega qualquer aviso de permissão
        ...
        try {
            ...
            LocationListener locationListener = new LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    mapJ.addMarker(new MarkerOptions().position(latLng).title("Hello There!"));
